    ...
    try:
        ...
        for user_num in range(1, int(cnt_sql[0][0]+1)):
            ...
            # chrome_options.add_argument("headless")
                ...
                try:
                    cursor.execute(
                        insert_sql, (zum_ns_url[0], ss[0], ss[1], zum_ns_url[1], ss[2], ss[3], zum_ns_url[2], ss[4], ss[5], zum_ns_url[3], ss[6], ss[7], zumWordCnt[0], zumWordCnt[1], zumWordCnt[2], zumWordCnt[3], summaryList[0], summaryList[1], summaryList[2], summaryList[3], res2[0][1], search))
                except:
                    pass
            try:
                db.commit()
...
schedule.every(34).seconds.do(schedule_fuction)
