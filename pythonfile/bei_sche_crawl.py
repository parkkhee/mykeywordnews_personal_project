    ...
    try:
        ...
        for user_num in range(1, int(cnt_sql[0][0]+1)):
            ...
            for search in nate_keyword:
                ...
                try:
                    cursor.execute(
                        insert_sql, (being_ns_url[0], ss[0], ss[1], being_ns_url[1], ss[2], ss[3], being_ns_url[2], ss[4], ss[5], being_ns_url[3], ss[6], ss[7], beingWordCnt[0], beingWordCnt[1], beingWordCnt[2], beingWordCnt[3], summaryList[0], summaryList[1], summaryList[2], summaryList[3], res2[0][1], search))
                except:
                    pass
            try:
                db.commit()
...
schedule.every(30).seconds.do(schedule_fuction)
